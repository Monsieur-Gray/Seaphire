use SysBase::defkeys::*;
use SysBase::mem_alloc::{mutate_mem, insert_to_mem};
use SysBase::reg_alloc::{mutate_reg, insert_to_reg};

use crate::ARITHMETIC::perf_math;
use crate::Compare;

use core_utils::fetch_data::fetch_bool;
use crate::Throw;
        ...
        Builtins::Expr {
            ...
            match expr[0] {
                ...
                Builtins::MemInst(MemInst::DEL) => {
                    let var = &core_utils::fetch_data::fetch_str(&expr[1]).unwrap();
